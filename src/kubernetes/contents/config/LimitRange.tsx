...
type LimitRangeObject = {
    metadata: any,
    spec: any,
    status: any
};

class LimitRangeComponent extends React.Component<LimitRangeProps, LimitRangeState> {
    child: React.RefObject<DetailComponent>;
    objectName: string;

    constructor(prop: LimitRangeProps) {
        super(prop);
        this.state = {
            items: [],
            currentItem: null,
...
export {LimitRangeObject, LimitRangeComponent};
