...
type ResourceQuotaObject = {
    metadata: any,
    spec: any,
    status: any
};

class ResourceQuotaComponent extends React.Component<ResourceQuotaProps, ResourceQuotaState> {
    child: React.RefObject<DetailComponent>;
    objectName: string;

    constructor(prop: ResourceQuotaProps) {
        super(prop);
        this.state = {
            items: [],
            currentItem: null,
...
export {ResourceQuotaObject, ResourceQuotaComponent};
