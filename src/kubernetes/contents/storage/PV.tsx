...
class PVComponent extends React.Component<PVProps, PVState> {
  ...
  capacity(item: any) {
    if (Object.prototype.hasOwnProperty.call(item.spec, 'capacity')) {
      if (Object.prototype.hasOwnProperty.call(item.spec.capacity, 'storage')) {
  ...
  claimRef(item: any) {
    if (Object.prototype.hasOwnProperty.call(item.spec, 'claimRef')) {
  ...
  storageClassName(item: any) {
    if (Object.prototype.hasOwnProperty.call(item.spec, 'storage_class_name')) {
