...
class EndpointComponent extends React.Component<EndpointProps, EndpointState> {
  child: React.RefObject<DetailComponent>;
  objectName: string;

  constructor(prop: EndpointProps) {
    super(prop);
    this.state = {
      items: [],
      currentItem: null
  ...
  endpoints(item: any) {
    if (Object.prototype.hasOwnProperty.call(item, 'subsets')) {
...
export { EndpointObject, EndpointComponent };
