...
class ServiceComponent extends React.Component<ServiceProps, ServiceState> {
  ...
  conditions(item: any) {
    if (Object.prototype.hasOwnProperty.call(item.status, 'conditions')) {
      return 'Pending';
    } else {
      return 'Active';
    }
  ...
  externalIPs(item: any) {
    if (Object.prototype.hasOwnProperty.call(item.spec, 'external_i_ps')) {
  ...
  selector(item: any) {
    if (Object.prototype.hasOwnProperty.call(item.spec, 'selector')) {
