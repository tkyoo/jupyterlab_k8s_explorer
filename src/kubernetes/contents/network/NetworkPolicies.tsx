...
class NetworkPolicyComponent extends React.Component<NetworkPolicyProps, NetworkPolicyState> {
    child: React.RefObject<DetailComponent>;
    objectName: string;

    constructor(prop: NetworkPolicyProps) {
        super(prop);
        this.state = {
            items: [],
            currentItem: null,
...
export {NetworkPolicyObject, NetworkPolicyComponent};
