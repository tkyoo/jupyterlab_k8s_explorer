...
type ClusterRoleBindingObject = {
  metadata: any;
  spec: any;
  status: any;
};

class ClusterRoleBindingComponent extends React.Component<
...
> {
  ...
  constructor(prop: ClusterRoleBindingProps) {
    super(prop);
    this.state = {
      items: [],
      currentItem: null
  ...
  bindings(item: any) {
    if (Object.prototype.hasOwnProperty.call(item, 'subjects')) {
...
export { ClusterRoleBindingObject, ClusterRoleBindingComponent };
