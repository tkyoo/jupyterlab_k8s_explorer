...
class ServiceAccountComponent extends React.Component<ServiceAccountProps, ServiceAccountState> {
    child: React.RefObject<DetailComponent>;
    objectName: string;

    constructor(prop: ServiceAccountProps) {
        super(prop);
        this.state = {
            items: [],
            currentItem: null,
...
export {ServiceAccountObject, ServiceAccountComponent};
