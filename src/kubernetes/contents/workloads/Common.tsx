...
type CommonWorkloadProps = {
    clickItem: Function,
    objectName: string
};

type CommonWorkloadState = {
    items: any[],
    currentItem: any,
};

type CommonWorkloadObject = {
    metadata: any,
    spec: any,
    status: any
};

class CommonWorkloadComponent extends React.Component<CommonWorkloadProps, CommonWorkloadState> {
    child: React.RefObject<DetailComponent>;
    objectName: string;

    constructor(prop: CommonWorkloadProps) {
        super(prop);
        this.state = {
            items: [],
            currentItem: null,
...
export {CommonWorkloadObject, CommonWorkloadComponent};
